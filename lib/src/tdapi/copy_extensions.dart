  ...
  Chat copy(
      ...
      Chat(
          ...
          voiceChatGroupCallId:
              voiceChatGroupCallId ?? this.voiceChatGroupCallId,
          isVoiceChatEmpty: isVoiceChatEmpty ?? this.isVoiceChatEmpty,
...
extension ChatInviteLinkCopyExtension on ChatInviteLink {
  ChatInviteLink copy({String? inviteLink}) =>
      ChatInviteLink(inviteLink: inviteLink ?? this.inviteLink);
}
...
extension InputCredentialsAndroidPayCopyExtension
    on InputCredentialsAndroidPay {
  InputCredentialsAndroidPay copy({String? data}) =>
      InputCredentialsAndroidPay(data: data ?? this.data);
}
...
extension GroupCallRecentSpeakerCopyExtension on GroupCallRecentSpeaker {
  GroupCallRecentSpeaker copy({int? userId, bool? isSpeaking}) =>
...
extension GroupCallCopyExtension on GroupCall {
  GroupCall copy(
      ...
      GroupCall(
          ...
          allowedChangeMuteNewParticipants: allowedChangeMuteNewParticipants ??
...
extension GroupCallJoinResponseCopyExtension on GroupCallJoinResponse {
  GroupCallJoinResponse copy(
...
extension GroupCallParticipantCopyExtension on GroupCallParticipant {
  GroupCallParticipant copy(
      ...
      GroupCallParticipant(
          ...
          source: source ?? this.source,
          isSpeaking: isSpeaking ?? this.isSpeaking,
          canBeMuted: canBeMuted ?? this.canBeMuted,
          canBeUnmuted: canBeUnmuted ?? this.canBeUnmuted,
...
extension ChatEventVoiceChatParticipantIsMutedToggledCopyExtension
  ...
  ChatEventVoiceChatParticipantIsMutedToggled copy(
          {int? userId, bool? isMuted}) =>
      ChatEventVoiceChatParticipantIsMutedToggled(
          userId: userId ?? this.userId, isMuted: isMuted ?? this.isMuted);
}
...
extension ChatReportReasonCustomCopyExtension on ChatReportReasonCustom {
  ChatReportReasonCustom copy({String? text}) =>
      ChatReportReasonCustom(text: text ?? this.text);
}
...
extension UpdateChatVoiceChatCopyExtension on UpdateChatVoiceChat {
  UpdateChatVoiceChat copy(
          {int? chatId, int? voiceChatGroupCallId, bool? isVoiceChatEmpty}) =>
      UpdateChatVoiceChat(
          chatId: chatId ?? this.chatId,
          voiceChatGroupCallId:
              voiceChatGroupCallId ?? this.voiceChatGroupCallId,
...
extension SendChatSetTtlMessageCopyExtension on SendChatSetTtlMessage {
  SendChatSetTtlMessage copy({int? chatId, int? ttl}) => SendChatSetTtlMessage(
...
extension GenerateChatInviteLinkCopyExtension on GenerateChatInviteLink {
  GenerateChatInviteLink copy({int? chatId}) =>
      GenerateChatInviteLink(chatId: chatId ?? this.chatId);
}
...
extension ToggleGroupCallParticipantIsMutedCopyExtension
  ...
  ToggleGroupCallParticipantIsMuted copy(
          {int? groupCallId, int? userId, bool? isMuted}) =>
...
extension DeleteSupergroupCopyExtension on DeleteSupergroup {
  DeleteSupergroup copy({int? supergroupId}) =>
      DeleteSupergroup(supergroupId: supergroupId ?? this.supergroupId);
}
...
extension ReportChatCopyExtension on ReportChat {
  ReportChat copy(
          {int? chatId, ChatReportReason? reason, List<int>? messageIds}) =>
      ReportChat(
          chatId: chatId ?? this.chatId,
          reason: reason ?? this.reason,
          messageIds: messageIds ?? this.messageIds);
